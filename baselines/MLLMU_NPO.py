...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_split_dir", type=str,help="Directory to save the model")
    parser.add_argument("--batch_size", type=int, default=4, help="Batch size for training")
    parser.add_argument("--forget_split_ratio", type=int, default=10, help="Directory to save the model")
    ...
    parser.add_argument("--ans_only", type=bool, default=True, help="Answer only for training")
