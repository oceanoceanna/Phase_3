...
def evaluate_classification(parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None):
    ...
    print(f"Classification image-textual Question Accuracy: {image_textual_accuracy:.2f}%")
...
def evaluate_fill_in_the_blank(parquet_file, processor, tokenizer, model, args, id_list_file=None, mode="default", forget_parquet_file=None):
    ...
    print(f"Cloze Image-Textual Question Accuracy: {image_textual_accuracy:.2f}%")
...
def evaluate_generation(parquet_file, processor, tokenizer, model, args, mode="default", forget_parquet_file=None):
    ...
    for i, row in tqdm(eval_samples.iterrows(), total=len(eval_samples)):
        image_id = row["ID"]
...
def parse_arguments():
    ...
    parser.add_argument('--data_split_folder', type=str)
    parser.add_argument('--test_data', type=str)
    parser.add_argument('--celebrity_data', type=str)
    
    parser.add_argument('--forget_ratio', type=int, default=10, help='Path to real person image folder.')
    parser.add_argument('--pretrain', type=bool, default=False, help="load pretrain model")
    parser.add_argument('--eval_list', type=str, required=False, default='forget_test_retain_real')
...
def main():
    ...
    if "forget_test_retain_real" in args.eval_list:
        print("************************IMAGE_TEXTUAL RESULT*****************:")
        print("#######################CLASSIFICATION RESULTS################:")
        print(f"Forget Set Classification image-textual Question Accuracy:{forget_classification_result['Classification image-textual Question Accuracy']}")
        print(f"Test Set Classification image-textual Question Accuracy:{test_classification_result['Classification image-textual Question Accuracy']}")
        print(f"Retain Set Classification image-textual Question Accuracy:{retain_classification_result['Classification image-textual Question Accuracy']}")
        print(f"Real Set Classification image-textual Question Accuracy:{real_classification_result['Classification image-textual Question Accuracy']}")

        print("#######################GENERATION RESULTS########################:")
        print(f"Forget Set Average ROUGE-L (Image_Textual):{forget_generation_result['Average ROUGE-L (Image_Textual)']}")
        print(f"Test Set Average ROUGE-L (Image_Textual):{test_generation_result['Average ROUGE-L (Image_Textual)']}")
        print(f"Retain Set Average ROUGE-L (Image_Textual):{retain_generation_result['Average ROUGE-L (Image_Textual)']}")
        print(f"Real Set Average ROUGE-L (Image_Textual):{real_generation_result['Average ROUGE-L (Image_Textual)']}")

        print("#######################CLOZE RESULTS########################:")
        print(f"Forget Set Cloze image_textual_accuracy:{forget_fill_in_the_blank_result['Cloze image_textual_accuracy']}")
        print(f"Test Set Cloze image_textual_accuracy:{test_fill_in_the_blank_result['Cloze image_textual_accuracy']}")
        print(f"Retain Set Cloze image_textual_accuracy:{retain_fill_in_the_blank_result['Cloze image_textual_accuracy']}")
        print(f"Real Set Cloze image_textual_accuracy:{real_fill_in_the_blank_result['Cloze image_textual_accuracy']}")
